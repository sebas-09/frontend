...
function Products() {
    ...
    return (
        <>
            <Header />
            {isLoading && <Loading />}
            {error && <Info message="No se pueden mostrar los productos en este momento. Inténtalo más tarde..." />}
            {!isLoading && !error && (
                <>
                        ...
                        products.map((product) => {
                            return (
                                <div className='box' key={product.id}>
                                    <img src={`${product.imageUrl}`} className="image" alt='producto'></img>
                                    <div className='price' aria-label='imagen'>$. {product.price}</div>
